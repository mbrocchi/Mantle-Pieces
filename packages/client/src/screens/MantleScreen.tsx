...
export function MantleScreen() {
  ...
  return (
    <div className="app-screen bg-gradient-to-b from-mahogany-dark to-black flex flex-col">
      ...
      <div className="px-4 pb-3">
        <div className="bg-black/30 rounded-xl px-4 py-2 text-white text-xs font-semibold">
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-4">
        <div className="bg-mahogany rounded-2xl border-4 border-mahogany-light p-3 grid grid-cols-2 gap-3">
        ...
        <button
          ...
          className="w-full mt-4 bg-black/30 text-gray-200 rounded-xl px-4 py-3 text-sm font-semibold transition-transform active:scale-95"
        >
